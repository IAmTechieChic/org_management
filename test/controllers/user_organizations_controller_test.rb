...
class UserOrganizationsControllerTest < ActionController::TestCase
  ...
  test "should create user_organization" do
    assert_difference('UserOrganization.count') do
      post :create, user_organization: { organization_id: @user_organization.organization_id, user_id: @user_organization.user_id }
    end
  ...
  test "should update user_organization" do
    patch :update, id: @user_organization, user_organization: { organization_id: @user_organization.organization_id, user_id: @user_organization.user_id }
    assert_redirected_to user_organization_path(assigns(:user_organization))
  end
